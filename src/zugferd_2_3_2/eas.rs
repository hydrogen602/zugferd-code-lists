...
impl crate::Code for EAS {
    fn code(self) -> &'static str {
        match self {
            ...
            EAS::DanishChamberOfCommerceSchemeEdiraCompliant => "0096",
            ...
            EAS::DanishMinistryInteriorAndHealth => "9901",
...
impl crate::Description for EAS {
    fn description(self) -> &'static str {
        match self {
            ...
            EAS::DanishMinistryInteriorAndHealth => "Danish Ministry of the Interior and Health",
...
impl crate::FromCode for EAS {
        ...
        Self: Sized,
    {
        match code {
            ...
            "0096" => Some(EAS::DanishChamberOfCommerceSchemeEdiraCompliant),
            ...
            "9901" => Some(EAS::DanishMinistryInteriorAndHealth),
