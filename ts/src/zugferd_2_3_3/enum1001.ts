...
export function description(value: Enum1001): string {
    switch (value) {
        ...
        case Enum1001.SelfBilledCorrectiveInvoiceInvoiceTypeCorrected: return " Self-billed corrective invoice, invoice type, Corrected";
        case Enum1001.FactoredCorrectiveInvoiceInvoiceTypeCorrected: return " Factored Corrective Invoice, invoice type, Corrected";
        case Enum1001.SelfBilledFactoredCorrectiveInvoiceInvoiceTypeCorrected: return " Self billed Factored corrective invoice, invoice type, Corrected";
        case Enum1001.SelfPrepaymentInvoiceInvoiceTypeOriginal: return " Self Prepayment invoice, invoice type, Original";
        case Enum1001.SelfBilledFactoredInvoiceInvoiceTypeOriginal: return " Self billed factored invoice, invoice type, Original";
        case Enum1001.SelfBilletFactoredCreditNoteCreditNoteTypeCorrected: return " Self billet factored Credit Note, Credit note type, Corrected";
        case Enum1001.PrepaymentCreditNoteCreditNoteTypeCorrected: return " Prepayment credit note, credit note type, Corrected";
