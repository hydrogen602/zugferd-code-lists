...
export function description(value: VATCAT): string {
    switch (value) {
        case VATCAT.PetroleumTax: return "Petroleum tax";
        case VATCAT.ProvisionalCountervailingDutyCash: return "Provisional countervailing duty cash";
        case VATCAT.ProvisionalCountervailingDutyBond: return "Provisional countervailing duty bond";
        case VATCAT.TobaccoTax: return "Tobacco tax";
        case VATCAT.EnergyFee: return "Energy fee";
        case VATCAT.CoffeeTax: return "Coffee tax";
        case VATCAT.HarmonisedSalesTaxCanadian: return "Harmonised sales tax, Canadian";
        case VATCAT.QuebecSalesTax: return "Quebec sales tax";
        case VATCAT.CanadianProvincialSalesTax: return "Canadian provincial sales tax";
        case VATCAT.TaxOnReplacementPart: return "Tax on replacement part";
        case VATCAT.MineralOilTax: return "Mineral oil tax";
        case VATCAT.SpecialTax: return "Special tax";
        case VATCAT.InsuranceTax: return "Insurance tax";
        case VATCAT.ProvincialCannabisTax: return "Provincial Cannabis Tax";
        case VATCAT.OutstandingDutyInterest: return "Outstanding duty interest";
        case VATCAT.AntiDumpingDuty: return "Anti-dumping duty";
        case VATCAT.StampDutyImpostaDiBollo: return "Stamp duty (Imposta di Bollo)";
        case VATCAT.AgriculturalLevy: return "Agricultural levy";
        case VATCAT.CarTax: return "Car tax";
        case VATCAT.PaperConsortiumTaxItaly: return "Paper consortium tax (Italy)";
        case VATCAT.CommoditySpecificTax: return "Commodity specific tax";
        case VATCAT.CustomsDuty: return "Customs duty";
        case VATCAT.CountervailingDuty: return "Countervailing duty";
        case VATCAT.EnvironmentalTax: return "Environmental tax";
        case VATCAT.ExciseDuty: return "Excise duty";
        case VATCAT.AgriculturalExportRebate: return "Agricultural export rebate";
        case VATCAT.FederalExciseTax: return "Federal excise tax";
        case VATCAT.Free: return "Free";
        case VATCAT.GeneralConstructionTax: return "General construction tax";
        case VATCAT.GoodsAndServicesTax: return "Goods and services tax";
        case VATCAT.IlluminantsTax: return "Illuminants tax";
        case VATCAT.ImportTax: return "Import tax";
        case VATCAT.IndividualTax: return "Individual tax";
        case VATCAT.BusinessLicenseFee: return "Business license fee";
        case VATCAT.LocalConstructionTax: return "Local construction tax";
        case VATCAT.LightDuesPayable: return "Light dues payable";
        case VATCAT.LocalSalesTax: return "Local sales tax";
        case VATCAT.LustTax: return "Lust tax";
        case VATCAT.MonetaryCompensatoryAmount: return "Monetary compensatory amount";
        case VATCAT.MiscellaneousCashDeposit: return "Miscellaneous cash deposit";
        case VATCAT.OtherTaxes: return "Other taxes";
        case VATCAT.ProvisionalDutyBond: return "Provisional duty bond";
        case VATCAT.ProvisionalDutyCash: return "Provisional duty cash";
        case VATCAT.PreferenceDuty: return "Preference duty";
        case VATCAT.SpecialConstructionTax: return "Special construction tax";
        case VATCAT.ShiftedSocialSecurities: return "Shifted social securities";
        case VATCAT.StateProvincialSalesTax: return "State/provincial sales tax";
        case VATCAT.SuspendedDuty: return "Suspended duty";
        case VATCAT.Surtax: return "Surtax";
        case VATCAT.ShiftedWageTax: return "Shifted wage tax";
        case VATCAT.AlcoholMarkTax: return "Alcohol mark tax";
        case VATCAT.Total: return "Total";
        case VATCAT.TurnoverTax: return "Turnover tax";
        case VATCAT.TonnageTaxes: return "Tonnage taxes";
        case VATCAT.ValuationDeposit: return "Valuation deposit";
        case VATCAT.ValueAddedTax: return "Value added tax";
    }
}
