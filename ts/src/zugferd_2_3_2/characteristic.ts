...
export function description(value: Characteristic): string {
    switch (value) {
        case Characteristic.ConsolidatedWeight: return "Consolidated weight";
        case Characteristic.NetWeight: return "Net weight";
        case Characteristic.GoodsItemGrossWeight: return "Goods item gross weight";
        case Characteristic.TotalNetWeight: return "Total net weight";
        case Characteristic.ConsignmentGrossWeight: return "Consignment gross weight";
        case Characteristic.NetNetWeight: return "Net net weight";
        case Characteristic.SternThrust: return "Stern thrust";
        case Characteristic.BowThrust: return "Bow thrust";
        case Characteristic.HydrateContentAnAlcoholicProductAtBottling: return "Hydrate content of an alcoholic product at bottling";
        case Characteristic.NumberUnitsPerPallet: return "Number of units per pallet";
        case Characteristic.FatContent: return "Fat content";
        case Characteristic.TransportMeansGrossWeight: return "Transport means gross weight";
        case Characteristic.NetTonnageVessel: return "Net tonnage of the vessel";
        case Characteristic.Humidity: return "Humidity";
        case Characteristic.Voltage: return "Voltage";
        case Characteristic.PowerConsumption: return "Power consumption";
        case Characteristic.HeatDissipation: return "Heat dissipation";
        case Characteristic.AirFlow: return "Air flow";
        case Characteristic.ShockImpact: return "Shock impact";
        case Characteristic.OperativeTemperature: return "Operative temperature";
        case Characteristic.NonOperativeTemperature: return "Non operative temperature";
        case Characteristic.GrossVolume: return "Gross volume";
        case Characteristic.NetVolume: return "Net volume";
        case Characteristic.WaterContent: return "Water content";
        case Characteristic.TensileStress: return "Tensile stress";
        case Characteristic.Fibrosity: return "Fibrosity";
        case Characteristic.GaugeLength: return "Gauge length";
        case Characteristic.Radius: return "Radius";
        case Characteristic.Straightness: return "Straightness";
        case Characteristic.Strain: return "Strain";
        case Characteristic.ItemWidthWhenUnrolled: return "Item width when unrolled";
        case Characteristic.ItemLengthWhenUnrolled: return "Item length when unrolled";
        case Characteristic.ItemAreaWhenUnrolled: return "Item area when unrolled";
        case Characteristic.OriginalWort: return "Original wort";
        case Characteristic.Volume: return "Volume";
        case Characteristic.Angle: return "Angle";
        case Characteristic.PegHoleHorizontalDistanceFromPackageLeftmostEdge: return "Peg hole horizontal distance from package leftmost edge";
        case Characteristic.PegHoleVerticalDistanceFromPackageTop: return "Peg hole vertical distance from package top";
        case Characteristic.NumberLayersPerPallet: return "Number of layers per pallet";
        case Characteristic.ProductStrenghChemical: return "Product strengh, chemical";
        case Characteristic.ProductStrengthBasisChemical: return "Product strength basis, chemical";
        case Characteristic.ItemWeight: return "Item weight";
        case Characteristic.PayloadWeightMaximum: return "Payload weight, maximum";
        case Characteristic.WeightConveyance: return "Weight of conveyance";
        case Characteristic.ConveyanceSummerDeadWeight: return "Conveyance summer dead weight";
        case Characteristic.ContainerizedCargoOnVesselsWeight: return "Containerized cargo on vessel's weight";
        case Characteristic.NonContainerizedCargoOnVesselsWeight: return "Non-containerized cargo on vessel's weight";
        case Characteristic.AscertainedWeight: return "Ascertained weight";
        case Characteristic.ChargeableWeight: return "Chargeable weight";
        case Characteristic.EstimatedGrossWeight: return "Estimated gross weight";
        case Characteristic.EstimatedVolume: return "Estimated volume";
        case Characteristic.VesselOverallLength: return "Vessel overall length";
        case Characteristic.LoadingMeters: return "Loading meters";
        case Characteristic.NumberAxles: return "Number of axles";
        case Characteristic.Payload: return "Payload";
        case Characteristic.StartPositionInLength: return "Start position in the length";
        case Characteristic.EndPositionInLength: return "End position in the length";
        case Characteristic.StartPositionInWidth: return "Start position in the width";
        case Characteristic.EndPositionInWidth: return "End position in the width";
        case Characteristic.StartPositionInThickness: return "Start position in the thickness";
        case Characteristic.EndPositionInThickness: return "End position in the thickness";
        case Characteristic.TransportContainerActualFillingWeight: return "Transport container actual filling weight";
        case Characteristic.TransportContainerMaximumCapacity: return "Transport container maximum capacity";
        case Characteristic.DeclaredNetWeight: return "Declared net weight";
        case Characteristic.LoadingHeight: return "Loading height";
        case Characteristic.StackingHeight: return "Stacking height";
        case Characteristic.CalculatedWeight: return "Calculated weight";
        case Characteristic.Ferrite: return "Ferrite";
        case Characteristic.Impurity: return "Impurity";
        case Characteristic.GrainSize: return "Grain size";
        case Characteristic.Lanthanides: return "Lanthanides";
        case Characteristic.Elasticity: return "Elasticity";
        case Characteristic.DrainedWeight: return "Drained weight";
        case Characteristic.Gallium: return "Gallium";
        case Characteristic.Strontium: return "Strontium";
        case Characteristic.Area: return "Area";
        case Characteristic.EquipmentStorageLimitation: return "Equipment storage limitation";
        case Characteristic.RadioactiveIndexTransport: return "Radioactive index of transport";
        case Characteristic.Radioactivity: return "Radioactivity";
        case Characteristic.AverageGrossWeight: return "Average gross weight";
        case Characteristic.ForwardDraft: return "Forward draft";
        case Characteristic.AfterDraft: return "After draft";
        case Characteristic.Acidity: return "Acidity";
        case Characteristic.TransportEquipmentGrossWeight: return "Transport equipment gross weight";
        case Characteristic.TotalTransportEquipmentGrossWeight: return "Total transport equipment gross weight";
        case Characteristic.AcidityJuice: return "Acidity of juice";
        case Characteristic.Penetrometry: return "Penetrometry";
        case Characteristic.Durofel: return "Durofel";
        case Characteristic.JuiceWeightPer100Grams: return "Juice weight per 100 grams";
        case Characteristic.FruitSkinColour: return "Fruit skin colour";
        case Characteristic.AngleBend: return "Angle of bend";
        case Characteristic.FixedIncrementalMeasurement: return "Fixed incremental measurement";
        case Characteristic.DurofelD10: return "Durofel D10";
        case Characteristic.DurofelD25: return "Durofel D25";
        case Characteristic.DurofelD50: return "Durofel D50";
        case Characteristic.MaximumStackingWeight: return "Maximum stacking weight";
        case Characteristic.GrossMeasureCube: return "Gross measure cube";
        case Characteristic.PercentageFatContentInDryMatter: return "Percentage fat content in dry matter";
        case Characteristic.SaccharometricContent: return "Saccharometric content";
        case Characteristic.HydrateContentAnAlcoholicProductAfterBottling: return "Hydrate content of an alcoholic product after bottling";
        case Characteristic.AnhydrousContent: return "Anhydrous content";
        case Characteristic.CertifiedWeight: return "Certified weight";
        case Characteristic.Freeboard: return "Freeboard";
        case Characteristic.MaximumVesselDraught: return "Maximum vessel draught";
        case Characteristic.NetExplosiveWeight: return "Net explosive weight";
        case Characteristic.RadioactiveCriticalitySafetyIndex: return "Radioactive criticality safety index";
        case Characteristic.WasteCurrentlyOnBoard: return "Waste currently on board";
        case Characteristic.WasteToBeDeliveredAtWasteReceptionFacility: return "Waste to be delivered at waste reception facility";
        case Characteristic.WasteToBeGeneratedUntilNextPortCallEstimated: return "Waste to be generated until next port of call, estimated";
        case Characteristic.WasteRemainingOnBoardAtDeparture: return "Waste remaining on board at departure";
        case Characteristic.ColourDepth: return "Colour depth";
        case Characteristic.ColourDepthMaximum: return "Colour depth, maximum";
        case Characteristic.ImageResolution: return "Image resolution";
        case Characteristic.DeviceResolutionMaximum: return "Device resolution, maximum";
        case Characteristic.AcousticAbsorptionCoefficient: return "Acoustic absorption coefficient";
        case Characteristic.BilledWeight: return "Billed weight";
        case Characteristic.BreakingLoad: return "Breaking load";
        case Characteristic.Platinum: return "Platinum";
        case Characteristic.Silver: return "Silver";
        case Characteristic.List: return "List";
        case Characteristic.Trim: return "Trim";
        case Characteristic.FreeWater: return "Free water";
        case Characteristic.Bands: return "Bands";
        case Characteristic.ApiAmericanPetroleumInstituteGravity: return "API (American Petroleum Institute) gravity";
        case Characteristic.PetroleumGrossObservedVolume: return "Petroleum gross observed volume";
        case Characteristic.PetroleumGrossStandardVolume: return "Petroleum gross standard volume";
        case Characteristic.VolumeVariance: return "Volume variance";
        case Characteristic.PetroleumNetStandardVolume: return "Petroleum net standard volume";
        case Characteristic.MaterialOnBoardQuantityAfterDischarge: return "Material on-board quantity, after discharge";
        case Characteristic.PetroleumTotalCalculatedVolume: return "Petroleum total calculated volume";
        case Characteristic.PetroleumTotalObservedVolume: return "Petroleum total observed volume";
        case Characteristic.InnageGaugeDistance: return "Innage gauge distance";
        case Characteristic.PetroleumNetStandardWeight: return "Petroleum net standard weight";
        case Characteristic.SedimentAndWaterInPetroleum: return "Sediment and water in petroleum";
        case Characteristic.ObservedReferenceHeightTank: return "Observed reference height, tank";
        case Characteristic.ReferenceHeightTank: return "Reference height, tank";
        case Characteristic.UllageGaugeDistance: return "Ullage gauge distance";
        case Characteristic.TrimCorrection: return "Trim correction";
        case Characteristic.BowToBridgeDistance: return "Bow to bridge distance";
        case Characteristic.PegHoleNumber: return "Peg hole number";
        case Characteristic.NumberInnerPacks: return "Number of inner packs";
        case Characteristic.NumberNextLevelTradeItemsWithinInnerPack: return "Number of next level trade items within inner pack";
        case Characteristic.NumberTradeItemsPerPalletLayer: return "Number of trade items per pallet layer";
        case Characteristic.PackedItemsLayerHeight: return "Packed items layer height";
        case Characteristic.PackingMaterialWeightSkinTightCovering: return "Packing material weight, skin tight covering";
        case Characteristic.Brightness: return "Brightness";
        case Characteristic.Brakes: return "Brakes";
        case Characteristic.ComponentsLabelledForRecyclingPercentage: return "Components labelled for recycling percentage";
        case Characteristic.RenewablePlasticComponentsPercentageByNetWeight: return "Renewable plastic components percentage, by net weight";
        case Characteristic.ClampPressureRequired: return "Clamp pressure, required";
        case Characteristic.Break: return "Break";
        case Characteristic.AscertainedVolume: return "Ascertained volume";
        case Characteristic.UnitWeight: return "Unit weight";
        case Characteristic.TotalVolume: return "Total volume";
        case Characteristic.UnitVolume: return "Unit volume";
        case Characteristic.VerticalCenterGravity: return "Vertical center of gravity";
        case Characteristic.MaximumAllowableTransportStackingWeight: return "Maximum allowable transport stacking weight";
        case Characteristic.CarbonDioxide: return "Carbon Dioxide";
        case Characteristic.NumberBaseUnitsPerPallet: return "Number of base units per pallet";
        case Characteristic.ColonyFormingUnit: return "Colony forming unit";
        case Characteristic.DilutedLiquidVolume: return "Diluted liquid volume";
        case Characteristic.EnergyEfficiency: return "Energy efficiency";
        case Characteristic.NumberLayers: return "Number of layers";
        case Characteristic.MaximumDemand: return "Maximum demand";
        case Characteristic.NumberPalletPlaces: return "Number of pallet places";
        case Characteristic.PackageNetMeasurementCubed: return "Package net measurement, cubed";
        case Characteristic.PowerFactor: return "Power factor";
        case Characteristic.StackingFactorExcludingBottomItem: return "Stacking factor excluding bottom item";
        case Characteristic.BreakingStrength: return "Breaking strength";
        case Characteristic.BreakingStrengthWet: return "Breaking strength wet";
        case Characteristic.StepSize: return "Step size";
        case Characteristic.NumberUnitsPerPackage: return "Number of units per package";
        case Characteristic.NumberUnitsPerLayer: return "Number of units per layer";
        case Characteristic.WeightPerRunningMetre: return "Weight per running metre";
        case Characteristic.WeightPerSquareMetre: return "Weight per square metre";
        case Characteristic.AcidityMeat: return "Acidity of meat";
        case Characteristic.SlaughteringWeight: return "Slaughtering weight";
        case Characteristic.StackingFactorIncludingBottomItem: return "Stacking factor including bottom item";
        case Characteristic.NumberUnitsInWidthALayer: return "Number of units in the width of a layer";
        case Characteristic.NumberUnitsInDepthALayer: return "Number of units in the depth of a layer";
        case Characteristic.NestablePercentage: return "Nestable percentage";
        case Characteristic.GrossWeightIncludingCarriersEquipment: return "Gross weight including carrier's equipment";
        case Characteristic.SugarContent: return "Sugar content";
        case Characteristic.SelfAcceleratingPolymerizationTemperatureSapt: return "Self-accelerating polymerization temperature (SAPT)";
        case Characteristic.SelfAcceleratingDecompositionTemperatureSadt: return "Self-accelerating decomposition temperature (SADT)";
        case Characteristic.ControlTemperature: return "Control temperature";
        case Characteristic.BasisWeight: return "Basis weight";
        case Characteristic.Change: return "Change";
        case Characteristic.EmergencyTemperature: return "Emergency temperature";
        case Characteristic.Colour: return "Colour";
        case Characteristic.ContentsPackage: return "Contents of package";
        case Characteristic.CommercialWeight: return "Commercial weight";
        case Characteristic.CoreLength: return "Core length";
        case Characteristic.DestinationWeightAgreement: return "Destination weight agreement";
        case Characteristic.Diameter: return "Diameter";
        case Characteristic.DeltaValueL: return "Delta value L";
        case Characteristic.Density: return "Density";
        case Characteristic.Depth: return "Depth";
        case Characteristic.Denier: return "Denier";
        case Characteristic.DistanceBetweenPoints: return "Distance between points";
        case Characteristic.WidthBoxcarDoor: return "Width, boxcar door";
        case Characteristic.EstimatedNewWeight: return "Estimated new weight";
        case Characteristic.Elongation: return "Elongation";
        case Characteristic.DeficitWeight: return "Deficit weight";
        case Characteristic.FilamentCount: return "Filament count";
        case Characteristic.LongitudinalFlatness: return "Longitudinal flatness";
        case Characteristic.Flatness: return "Flatness";
        case Characteristic.TransverseFlatness: return "Transverse flatness";
        case Characteristic.Gauge: return "Gauge";
        case Characteristic.GrossWeightMaximum: return "Gross weight, maximum";
        case Characteristic.Hardness: return "Hardness";
        case Characteristic.HeightMaximum: return "Height, maximum";
        case Characteristic.HeightDimension: return "Height dimension";
        case Characteristic.ImpactEnergy: return "Impact energy";
        case Characteristic.InsideDiameter: return "Inside diameter";
        case Characteristic.LegalWeight: return "Legal weight";
        case Characteristic.LengthMaximum: return "Length, maximum";
        case Characteristic.Length: return "Length";
        case Characteristic.LostEnd: return "Lost end";
        case Characteristic.MinimumWeight: return "Minimum weight";
        case Characteristic.Moisture: return "Moisture";
        case Characteristic.MaximumWeight: return "Maximum weight";
        case Characteristic.ActualNetWeight: return "Actual net weight";
        case Characteristic.OutsideDiameter: return "Outside diameter";
        case Characteristic.PreStretch: return "Pre stretch";
        case Characteristic.PerTonne: return "Per tonne";
        case Characteristic.RelativeHumidity: return "Relative humidity";
        case Characteristic.Resistivity: return "Resistivity";
        case Characteristic.RockwellC: return "Rockwell C";
        case Characteristic.ReamWeight: return "Ream weight";
        case Characteristic.ReductionArea: return "Reduction of area";
        case Characteristic.RunProcess: return "Run (process)";
        case Characteristic.Ratio: return "Ratio";
        case Characteristic.ShippedQuantity: return "Shipped quantity";
        case Characteristic.TareWeight: return "Tare weight";
        case Characteristic.Temperature: return "Temperature";
        case Characteristic.Thickness: return "Thickness";
        case Characteristic.TimePeriod: return "Time period";
        case Characteristic.Time: return "Time";
        case Characteristic.TransportEquipmentVerifiedGrossMassWeight: return "Transport equipment verified gross mass (weight)";
        case Characteristic.HeightVanDoor: return "Height, van door";
        case Characteristic.WidthVanDoor: return "Width, van door";
        case Characteristic.WeightPerUnitArea: return "Weight per unit of area";
        case Characteristic.WidthDimension: return "Width dimension";
        case Characteristic.WidthMaximum: return "Width, maximum";
        case Characteristic.WeightPerUnitLength: return "Weight per unit of length";
        case Characteristic.SideHeightFlatBedWithRemovableSides: return "Side height, flat bed with removable sides";
        case Characteristic.Squareness: return "Squareness";
        case Characteristic.SpoolSize: return "Spool size";
        case Characteristic.YieldStress: return "Yield stress";
        case Characteristic.Aluminium: return "Aluminium";
        case Characteristic.Arsenic: return "Arsenic";
        case Characteristic.Boron: return "Boron";
        case Characteristic.Bismuth: return "Bismuth";
        case Characteristic.Carbon: return "Carbon";
        case Characteristic.Calcium: return "Calcium";
        case Characteristic.Columbium: return "Columbium";
        case Characteristic.Cerium: return "Cerium";
        case Characteristic.Chlorine: return "Chlorine";
        case Characteristic.Cobalt: return "Cobalt";
        case Characteristic.Chromium: return "Chromium";
        case Characteristic.Copper: return "Copper";
        case Characteristic.Iron: return "Iron";
        case Characteristic.IronPlusSilicon: return "Iron plus silicon";
        case Characteristic.Germanium: return "Germanium";
        case Characteristic.Hydrogen: return "Hydrogen";
        case Characteristic.Potassium: return "Potassium";
        case Characteristic.Magnesium: return "Magnesium";
        case Characteristic.Manganese: return "Manganese";
        case Characteristic.Molybdenum: return "Molybdenum";
        case Characteristic.Nitrogen: return "Nitrogen";
        case Characteristic.Sodium: return "Sodium";
        case Characteristic.Niobium: return "Niobium";
        case Characteristic.Nickel: return "Nickel";
        case Characteristic.Oxygen: return "Oxygen";
        case Characteristic.Phosphorus: return "Phosphorus";
        case Characteristic.Lead: return "Lead";
        case Characteristic.Sulphur: return "Sulphur";
        case Characteristic.Antimony: return "Antimony";
        case Characteristic.Selenium: return "Selenium";
        case Characteristic.Silicon: return "Silicon";
        case Characteristic.SiliciumOxyd: return "Silicium oxyd";
        case Characteristic.Tin: return "Tin";
        case Characteristic.Tantalium: return "Tantalium";
        case Characteristic.Tellurium: return "Tellurium";
        case Characteristic.Titanium: return "Titanium";
        case Characteristic.Vanadium: return "Vanadium";
        case Characteristic.Tungsten: return "Tungsten";
        case Characteristic.WasteContent: return "Waste content";
        case Characteristic.Zinc: return "Zinc";
        case Characteristic.Zirconium: return "Zirconium";
        case Characteristic.MutuallyDefined: return "Mutually defined";
        case Characteristic.BestBeforeDate: return "Best before date";
        case Characteristic.ColourAsText: return "Colour as text";
        case Characteristic.CommissionIndicator: return "Commission indicator";
        case Characteristic.DepositSystem: return "Deposit system";
        case Characteristic.DepositType: return "Deposit type";
        case Characteristic.EnergyEfficiencyClass: return "Energy efficiency class";
        case Characteristic.ExpirationDate: return "Expiration date";
        case Characteristic.FeeIndicator: return "Fee indicator";
        case Characteristic.TypeArticle: return "Type of article";
        case Characteristic.MaterialProduct: return "Material of the product";
        case Characteristic.MeteringPointDesignationEGForElectricityOrGas: return "Metering point designation, e.g. for electricity or gas";
        case Characteristic.MeterNumberEGForElectricityOrGas: return "Meter number, e.g. for electricity or gas";
        case Characteristic.OrganicControlBodyNumber: return "Organic control body number";
        case Characteristic.PackagingMaterial: return "Packaging material";
        case Characteristic.TypePackagingCode: return "Type of packaging (code)";
        case Characteristic.NumberActionVariant: return "Number of the action variant";
        case Characteristic.SealNumber: return "Seal number";
        case Characteristic.SizeCode: return "Size code";
        case Characteristic.SizeDesignation: return "Size designation";
        case Characteristic.TypeTradingUnit: return "Type of trading unit";
        case Characteristic.WasteCodeEwc: return "Waste code (EWC)";
        case Characteristic.WasteFraction: return "Waste fraction";
        case Characteristic.WeeeRegistrationNumber: return "WEEE registration number";
    }
}
